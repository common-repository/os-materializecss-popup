<?php 
/*
* OS Materializecss Popup Design 1
...
$custom_css .=  "}
				...
				.osmp-model-popup .modal {
					background-color: {$bg_color};
				}
				.osmp-modal { font-size: {$body_font_size}; }
				.osmp-modal h1 { font-size: {$offer_font_size}; color: {$offer_font_color}; }
				.osmp-modal span, .osmp-modal a { color: {$heading_font_color}; font-size: {$heading_font_size}; }
				.osmp-modal form input[type=\"submit\"],
				.osmp-modal form input[type=\"button\"] {
					background-color: {$button_color};
					color: {$button_font_color};
					font-size: {$button_font_size};
					line-height: {$button_font_size};
...
<div id="osmp-modal-<?php echo $post_id;?>" class="modal osmp-modal">
	<div class="modal-content">
		<?php if( $popup_heading ) { ?><span><?php echo $popup_heading; ?></span><?php } ?>
		<?php if( $offer_txt ) {?><?php echo $offer_txt; ?><?php } ?>
