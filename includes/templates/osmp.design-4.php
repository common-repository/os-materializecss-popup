<?php 
/*
* OS Materializecss Popup Design 4
...
$custom_css .=  "}
				...
				.osmp-modal.modal.design-4 .osmp-form form label {
					color: {$heading_font_color}; 
				}
				.osmp-model-popup .modal.design-4 .modal-content p {
					color: {$offer_font_color}; 
				}
				.osmp-model-popup .modal.design-4 .modal-content .osmp-form form input[type=\"submit\"],
				.osmp-model-popup .modal.design-4 .modal-content .osmp-form form input[type=\"button\"] {
					background-color: {$button_color};
					color: {$button_font_color};
					font-size: {$button_font_size};
					line-height: {$button_font_size};
